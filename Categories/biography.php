...
<head>
    ...
    <title>Biography Books | Book Wise Library</title>
            ...
            <div class="books-table">
                <table>
                    ...
                    <tbody>
                        ...
                        $books = $conn->query("SELECT * FROM books WHERE category = 'biography'")->fetch_all(MYSQLI_ASSOC);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="/LibraryMS/Categories/biography.php">
