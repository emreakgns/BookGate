...
<head>
    ...
    <title>Autobiography Books | Book Wise Library</title>
    <link rel="icon" href="/LibraryMS/HomePage/bookgatelogo.png" type="image/png">
    <link rel="stylesheet" href="autobiography.css">
</head>
<body>
    <!-- Header -->
    <header>
        ...
        <div class="header-content">
            ...
            <div class="welcome-message">
                <h1>Autobiography Books</h1>
                <p>Explore autobiography books</p>
            </div>
        </div>
    </header>
            ...
            <div class="books-table">
                <table>
                    ...
                    <tbody>
                        ...
                        $books = $conn->query("SELECT * FROM books WHERE category = 'autobiography'")->fetch_all(MYSQLI_ASSOC);
                        foreach ($books as $book): ?>
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="/LibraryMS/Categories/autobiography.php">
