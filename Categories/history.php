...
<head>
    ...
    <title>History Books | Book Wise Library</title>
            ...
            <div class="books-table">
                <table>
                    ...
                    <tbody>
                        ...
                        $books = $conn->query("SELECT * FROM books WHERE category = 'history'")->fetch_all(MYSQLI_ASSOC);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="/LibraryMS/Categories/history.php">
